...
<body>
    ...
    <section class="welcome-page">
        <div class="welcome-titel">
            <h2>Welcome to the <br>Polish Restaurant</h2>
            <a href="order.php" class="welcome-page-button">Order</a>
        </div>
        <div class="welcome-text-container">
            <div class="welcome-text">
                <p>Are you looking for a place where tradition meets modernity and passion and experience are served on a plate in a form of unique dishes? </p>
                <br>
